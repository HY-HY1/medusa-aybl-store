...
const Payment = ({
  ...
  const useOptions: StripeElementStyle = useMemo(() => {
    return {
      theme: 'flat',
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      ...
                      <CardNumberElement
                        ...
                        className="pt-3 pb-1 block w-full h-11 px-4 mt-0 bg-ui-bg-field border rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-ui-border-base hover:bg-ui-bg-field-hover transition-all duration-300 ease-in-out"
                      />
                    </div>
